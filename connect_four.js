...
const resetWinClick = document.getElementById('overlayWin');
const resetClick = document.getElementById('overlayReset');
...
function baseGame() {
  for (let i=0; i < 6; i++) {
    for (let j=0; j < 7; j++) {
        ...
        if (winCheck() === 1) {
          overlayOn(1);
          resetWinClick.addEventListener("click", function() {
            changeMode(1);
          })
        } else if (winCheck() === 2) {
          overlayOn(2);
...
function inputMode() {
	if (gravityEnabled) {
  	document.getElementById('output').innerHTML = "Regular Mode"
  } else {
  	document.getElementById('output').innerHTML = "0G Mode"
  }
}
...
function overlayOn(n) {
    ...
    document.getElementById("overlayWin").style.background = "darkred";
    document.getElementById("overlayWin").style.opacity = ".5";
    document.getElementById("winText").innerHTML = "Red wins! Resetting."
    document.getElementById("winText").style.color = "white";
    document.getElementById("winText").style.opacity = "1";
    return;
	} if (n === 2) {
    document.getElementById("overlayWin").style.display = "block";
    document.getElementById("overlayWin").style.background = "blue";
    document.getElementById("overlayWin").style.opacity = ".5";
    document.getElementById("winText").innerHTML = "Blue wins! Resetting.."
    document.getElementById("winText").style.color = "white";
    document.getElementById("winText").style.opacity = "1";
    return;
  } else {
 	 document.getElementById("overlayReset").style.display = "block";
   return;
  }
}
